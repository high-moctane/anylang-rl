...
class Plotter:
    def __init__(self, history_path: str):
        ...
        self.pole_len = 1.
        self.frame_per_sec = 50
        self.tick = 1 / self.frame_per_sec
    ...
    def read_history(self, path):
        actions, rewards, states, info = [], [], [], []
        with open(path) as f:
            for line in f:
                action, reward, state, inf = line.rstrip().split("\t")
    ...
    def save(self):
        ...
        self.ani.save(path, writer="pillow")
